export default {
  hero: {
    ...
    title: {
      ...
      line2: 'interfaces,',
      line3: 'and interactive experiences.',
    },
    description:
      'Frontend developer focused on Vue 3, UI architecture, dashboards, and game-inspired experiences.',
    actions: {
  ...
  about: {
    label: 'ABOUT',
    title: 'Building software from interface to deployment.',
    items: [
